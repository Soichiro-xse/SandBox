...
# Read HTML at import time so it's baked into the image
import pathlib as _pathlib

_html_path = _pathlib.Path(__file__).with_name("chat-app.html")
CHAT_HTML = _html_path.read_text() if _html_path.exists() else "<h1>chat-app.html not found</h1>"
